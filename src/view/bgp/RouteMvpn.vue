...
<script setup>
    ...
    import { BGP_ADDR_FAMILY, BGP_EVENT_PAGE_ID, DEFAULT_VALUES, BGP_MVPN_ROUTE_TYPE } from '../../const/bgpConst';
    ...
    useBgpRouteRuntime(BGP_EVENT_PAGE_ID.PAGE_ID_ROUTE_MVPN, {
