...
const BGP_REQ_TYPES = {
    ...
    DELETE_ALL_ROUTES_BY_FAMILY: 14,
    IMPORT_ROUTES: 15,
    GET_INSTANCE_INFO: 16,
    GENERATE_IPV4_QP_ROUTES: 17,
    ...
    SAVE_IPV4_QP_ROUTE_CONFIG: 32,
    LOAD_IPV4_QP_ROUTE_CONFIG: 33,
    SAVE_IPV6_QP_ROUTE_CONFIG: 34,
    LOAD_IPV6_QP_ROUTE_CONFIG: 35
};
